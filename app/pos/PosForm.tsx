...
export function PosForm(props: {
  ...
  grades: Product[];
  users: User[];
  vatRateDecimal: string; // e.g. "0.1925"
  ...
  return (
    <form
      ...
      className="space-y-6"
      onSubmit={() => {
        // ensure latest state is submitted via hidden inputs
      }}
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="grid gap-2">
          ...
          <div className="text-xs opacity-70">
            VAT: {vatApplicable ? "applies" : "exempt"} (rate {vatApplicable ? "19.25%" : "0%"}) · Regime:{" "}
      ...
      <section className="rounded-lg border border-black/10 dark:border-white/10 p-4 space-y-2">
        ...
        <div className="text-xs opacity-70">
          No credit sales: paid must equal total.
        </div>
      </section>
