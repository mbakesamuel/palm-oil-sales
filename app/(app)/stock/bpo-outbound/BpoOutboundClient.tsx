  ...
  return (
    <div className="space-y-8">
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold">BPO Gift / Out</h1>
        <p className="text-sm opacity-75">
          Post Bottled Palm Oil outbound movements from Bota stock. Use reason Gift for GM public relations; add other reasons as needed.
        </p>
      </div>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="grid gap-1">
            ...
            <input name="reason" defaultValue="Gift" className="rounded-md border border-black/10 dark:border-white/10 bg-transparent px-3 py-2" />
          </div>
          <div className="grid gap-1">
        ...
        <button disabled={!canPost || !botaAvailable || variants.length === 0 || busy} className="rounded-md bg-black text-white dark:bg-white dark:text-black px-4 py-2 text-sm font-medium disabled:opacity-50">
          Post movement
        </button>
