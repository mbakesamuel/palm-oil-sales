    ...
    >
      ...
      >
        ...
        <View style={styles.brandMark}>
          ...
          <Ionicons name="leaf-outline" size={28} color={agro.forest} />

        </View>

        <Text style={styles.title}>Sales Management App</Text>

        <Text style={styles.subtitle}>(Simplify your sales management process)</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: "700", marginBottom: 4, color: agro.text },

  subtitle: { fontSize: 14, color: agro.textMuted, marginBottom: 8 },
